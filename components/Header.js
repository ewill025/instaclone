...
function Header() {
  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
      <div className="flex justify-between max-w-6xl mx-5 md:mx-40">
        {/* LOGO*/}
        <div
          onClick={() => router.push("/")}
        ...
        >
          <Image
            src="https://cdn.sanity.io/images/ub6yj6nr/production/a9140c898a6d413817b773068d6a91c0b85176f4-75x55.svg"
            layout="fill"
            objectFit="contain"
            alt="logo"
          />
